...
def sample_net():
    ...
    conv2 = L.Convolution(conv2_dw_relu, name='conv2',kernel_size=1, num_output=2, stride=1, pad=0, bias_term=False, group=1, weight_filler=dict(type='xavier') )
